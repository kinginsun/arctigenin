...
C50= THETA(7)*EXP(ETA(6))		; Dose at 1/2*Km
...
; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab147.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab147.tab
