;; 1. Based on: run134
;; 2. Description: FINAL IG, Three dose, CL, F1, CL adjust by dose
;; x1. Author: RZ
...
; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab136.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab136.tab
