...
DADT(4)= BIO*Ka*A(1)-tKi*A(4)-Kb*A(4)
...
; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab133.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab133.tab
