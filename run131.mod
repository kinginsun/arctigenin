;; 1. Based on: run128
;; 2. Description: FINAL IG, Three dose, CL, BIO
;; x1. Author: RZ
...
; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab131.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab131.tab
